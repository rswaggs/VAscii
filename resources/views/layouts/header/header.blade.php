    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand navbar-brand-center" href="javascript:void(0)">
            ...
            <img class="navbar-brand-logo navbar-brand-logo-special" src="../../assets/images/logo-blue.png"
                 title="VAscii">
            <span class="navbar-brand-text hidden-xs-down"> VAscii</span>
        </a>
    </div>
              ...
              <span class="avatar avatar-online">
                ...
                <i></i>
                    ...
                    <div class="dropdown-menu" role="menu">
                        ...
                        <a class="dropdown-item logout-link" href="javascript:void(0)" role="menuitem"><i class="icon wb-power" aria-hidden="true"></i> Logout</a>
